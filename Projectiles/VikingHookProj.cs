...
namespace IwansMod.Projectiles
{
    class VikingHookProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("VikingHook");
        }
        ...
        public override bool? CanUseGrapple(Player player)
        {
            ...
            if (hooksOut > 4) // This hook can have 3 hooks out.
            {
                return false;
            }
            return true;
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            while (distance > 30f && !float.IsNaN(distance))
            {
                ...
                //Draw chain
                spriteBatch.Draw(mod.GetTexture("Items/Tools/VikingHookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
